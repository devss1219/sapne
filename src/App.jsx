...
import { Home, Car, Bike, Ban, Wallet, TrendingUp, HeartPulse } from 'lucide-react';

export default function App() {
  // Global Body Background Fix (Removes white space at bottom)
  useEffect(() => {
  ...
  // Core Cashflow State
  const [salary, setSalary] = useState(68000);
  const [personalExp, setPersonalExp] = useState(25000);
  ...
  // Dynamic Slider Configs based on Loan Type
  ...
  // Ideal 50-30-20 Rule Data for Donut Chart
  const pieData = [
          ...
          <div className="lg:col-span-7 bg-[#12141a] rounded-3xl p-5 md:p-6 border border-gray-800/50 shadow-2xl">
            ...
            <div className="bg-[#0a0a0a] rounded-2xl p-4 border border-gray-800">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-3">
                ...
                {/* Loan Presets */}
                <div className="flex bg-[#12141a] p-1 rounded-lg border border-gray-800 overflow-x-auto w-full md:w-auto">
              ...
              {loanType !== 'none' ? (
                <div className="space-y-4">
                  ...
                  {/* Dynamic Calculated EMI Display */}
